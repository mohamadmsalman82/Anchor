    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-2">
          ...
          <div className="relative">
            {profilePictureUrl ? (
              <img
                ...
                alt="Profile"
                className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg shadow-slate-200/50"
              />
            ) : (
              <div className={`w-20 h-20 rounded-full ${getAvatarColor(user.email)} flex items-center justify-center text-white text-3xl font-bold border-4 border-white shadow-lg shadow-slate-200/50`}>
                {getInitials(user.email)}
              </div>
            )}
            <div className="absolute -bottom-1 -right-1 bg-teal-400 text-white p-1.5 rounded-full border-2 border-white shadow-sm" title="You're active">
        ...
        <div className="hidden lg:block text-right">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur border border-white/60 rounded-full shadow-sm text-sm text-slate-600">
             <span className="animate-pulse w-2 h-2 rounded-full bg-teal-400"></span>
             <span>System Status: <span className="font-semibold text-slate-800">Ready to Focus</span></span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <AnchorCard className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none overflow-hidden group">
          {/* Subtle background glow */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 rounded-full blur-3xl -mr-32 -mt-32 transition-all duration-700 group-hover:bg-teal-500/20"></div>
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="mt-4">
              ...
              <p className="text-teal-400/90 text-sm font-medium mt-1">
        ...
        <AnchorCard>
           <div className="flex flex-col h-full justify-between">
            <div className="flex justify-between items-start">
              <span className="text-slate-500 text-xs font-bold uppercase tracking-wider">Weekly Total</span>
            ...
            <div className="mt-4">
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-slate-900">{formatDuration(totalLockedIn)}</span>
              </div>
        ...
        <AnchorCard>
           <div className="flex flex-col h-full justify-between">
            <div className="flex justify-between items-start">
              <span className="text-slate-500 text-xs font-bold uppercase tracking-wider">Focus Quality</span>
            ...
            <div className="mt-4">
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-slate-900">{formatFocusRate(avgRate)}</span>
