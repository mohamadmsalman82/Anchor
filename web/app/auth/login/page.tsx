      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="relative w-20 h-20 bg-slate-900/90 rounded-3xl flex items-center justify-center mb-6 shadow-2xl shadow-slate-950/40 group border border-slate-700/70">
            <div className="absolute inset-0 bg-gradient-to-tr from-teal-500 to-indigo-500 rounded-3xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 blur-2xl"></div>
          ...
          <h1 className="text-4xl font-bold text-slate-50 tracking-tight mb-2">Anchor</h1>
          <p className="text-slate-300 text-lg">Drop anchor. Cut the noise.</p>
        </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
          <AnchorCard className="p-8 md:p-10 border-slate-700/70 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-slate-950/40">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-slate-300 mt-1">Ready to focus?</p>
            </div>
            
            <AuthForm mode="login" />

            <div className="mt-8 pt-6 border-t border-slate-700/70 text-center">
              <p className="text-sm text-slate-400 mb-3">New to Anchor?</p>
              <Link 
                href="/auth/register" 
