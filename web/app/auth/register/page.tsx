  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-0 w-[800px] h-[800px] bg-indigo-500/5 rounded-full blur-3xl animate-pulse duration-3000"></div>
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-teal-400/5 rounded-full blur-3xl animate-pulse duration-2000"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="relative w-20 h-20 bg-slate-900 rounded-3xl flex items-center justify-center mb-6 shadow-2xl shadow-slate-900/20 group">
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500 to-teal-500 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl"></div>
          ...
          <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-2">Join Anchor</h1>
          <p className="text-slate-500 text-lg">Focus deeper. Achieve more.</p>
        </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
          <AnchorCard className="p-8 md:p-10 border-white/60 bg-white/80 backdrop-blur-xl shadow-2xl shadow-slate-200/50">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-slate-500 mt-1">Start your deep work journey.</p>
            </div>
            
            <AuthForm mode="register" />

            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-sm text-slate-500 mb-3">Already anchored?</p>
              <Link 
                href="/auth/login" 
